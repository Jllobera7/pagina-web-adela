...
Se han implementado en los formularios de "Inicia Sesión", "Regístrate" y "Sobre Nosotros" la validación en Javascript, un sistema dinámico para mostrar y enviar comentarios, y un efecto de mostrar/ocultar contraseñas.
...
| Integrante    | Tarea realizada                                         | Tiempo dedicado | Descripción del trabajo                                                                 |
|--------------|------------------------------------------------------------|---------------|---------------------------------------------------------------------------------------|
